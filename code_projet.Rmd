...
plot(sil_2, main = "Silhouette plot (K=2)")
print(paste("Silhouette moyenne (K=2):", mean(sil_2[,3])))
...
plot(sil_3, main = "Silhouette plot (K=3)")
print(paste("Silhouette moyenne (K=3):", mean(sil_3[,3])))
```
